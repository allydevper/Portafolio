            ...
            {projects.map((project) => (
                <div key={project.id} className="bg-gray-800 rounded-2xl flex flex-col h-full">
                    ...
                    <div className="p-6 flex justify-between">
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-brand-github">
                        ...
                        {project.url_demo && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-4 py-2 bg-yellow-300 text-black font-bold flex items-center rounded-full hover:bg-white hover:text-black transition duration-300 cursor-pointer"
                            >
                                Ver Demo
                            </a>
                        )}
